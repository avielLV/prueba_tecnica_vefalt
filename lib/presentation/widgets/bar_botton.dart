...
class BarBotton extends ConsumerWidget {
  const BarBotton({super.key});
        ...
        children: [
          InkWell(
            onTap: () async {
              ...
              ref.read(posicionProvider.notifier).update(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  SvgPicture.asset('$carpIcon/bat_botton_point.svg'),
                  SvgPicture.asset('$carpIcon/bar_botton_record.svg'),
                ],
              ),
            ),
          ),
